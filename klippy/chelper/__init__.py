...
SOURCE_FILES = [
    ...
    'kin_cartesian.c', 'kin_corexy.c', 'kin_rotab.c', 'kin_corexz.c',
    'kin_delta.c', 'kin_deltesian.c', 'kin_polar.c', 'kin_rotary_delta.c',
    'kin_winch.c', 'kin_extruder.c', 'kin_shaper.c',
]
...
defs_trapq = """
    struct pull_move {
        ...
        double start_x, start_y, start_z, start_a, start_b;
        double x_r, y_r, z_r, a_r, b_r;
    };
    ...
    void trapq_append(struct trapq *tq, double print_time
        ...
        , double start_pos_x, double start_pos_y, double start_pos_z, double start_pos_a, double start_pos_b
        , double axes_r_x, double axes_r_y, double axes_r_z, double axes_r_a, double axes_r_b
        , double start_v, double cruise_v, double accel);
    void trapq_finalize_moves(struct trapq *tq, double print_time);
    void trapq_set_position(struct trapq *tq, double print_time
        , double pos_x, double pos_y, double pos_z, double pos_a, double pos_b);
...
defs_kin_rotab = """
    struct stepper_kinematics *rotab_stepper_alloc(char type);
"""
...
defs_all = [
    ...
    defs_kin_cartesian, defs_kin_corexy, defs_kin_rotab, defs_kin_corexz,
